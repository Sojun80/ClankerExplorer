...
public sealed class UiSmokeTests
{
    ...
    [Fact]
    public void VlcVideoService_RecognizesVideoExtensions()
    {
        Assert.True(ClankerExplorer.Services.VideoThumbnailService.IsVideoFile("movie.mp4"));
        Assert.True(ClankerExplorer.Services.VideoThumbnailService.IsVideoFile("clip.mkv"));
        Assert.True(ClankerExplorer.Services.VideoThumbnailService.IsVideoFile("video.webm"));
        Assert.False(ClankerExplorer.Services.VideoThumbnailService.IsVideoFile("picture.png"));
        Assert.False(ClankerExplorer.Services.VideoThumbnailService.IsVideoFile(""));
    }
